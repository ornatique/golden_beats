...
<section class="content">
    <div class="container-fluid">
        ...
        <div class="card card-primary">
            ...
            <form id="createUserForm" method="POST" action="{{ route('admin.customers.store') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="card-body">
                    ...
                    <div class="card-footer text-right">
                        <a href="{{ route('admin.customers.index') }}" class="btn btn-info">
